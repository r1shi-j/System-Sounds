...
class Sound {
    ...
    static var sounds: [Sound] {
        [
            ...
            .init(number: "1061", name: "AirTag Ping Loud"),
            ...
            .init(number: "1263", name: "Loud"),
            .init(number: "1264", name: "Loud"),
            ...
            .init(number: "1401", name: "Watch Call Long"),
